...
<body>
    ...
    <img class="imagenes" src={imagenes("./anuncios/hacienda1.jpg")} alt=""/>
				<div class="detalles-content">
					<h1>Hacienda, Nayon</h1>
{/* 						<p class="price"><b>Precio: </b> $${producto.price}</p> */}
						<p class="description">
							<b>Descripcion: </b> <span>
              Vendemos una Hacienda con casa incluida. Tiene 6 habitaciones y 3 baños. Tiene garaje y sótano. Hay un jardín en frente. La casa tiene varias ventanas, es cómoda, espaciosa y fresca. Los baños, el techo, las paredes y todas las partes de la casa están en buen estado. La sala tiene una chimenea para que la casa se caliente durante el invierno.
              </span>
						</p>
						<p class="description">
							<span>La casa luce antigua pero está muy bien cuidada. Hay suficiente espacio para construir aún más. Es bonita y está ubicada en un lugar seguro.</span>
						</p>
            ...
            <ul class="list-a">
                ...
                <li>Internet</li>
                <li>Parqueadero</li>
                <li>Cuarto de Secado</li>
                <li>Cuarto de Jardineria</li>
              </ul>
              <nav className="cont" id="cont">
