...
import InmuebleListE from './Componets/InmuebleListE'
import FormE from './Componets/FormE';
    ...
    <Fragment>
      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <InmuebleListE inmueble={inmueble} setInmueble={setInmueble} inmuebles={inmuebles}  setListUpdated={setListUpdated} ></InmuebleListE>
          <a href="AppL">
          <button type="submit" className="btn btn-success" >Regresar</button>
          </a>
          </div>
          <div className='col-3'>
          <h2 style={{textAlign: 'center'}}>Inmuebles Form</h2>
          <FormE inmueble={inmueble} setInmueble={setInmueble}></FormE>
