...
<body>
    ...
    <img src={imagenes("./anuncios/terreno1.jpg")} alt=""/>
				<div class="detalles-content">
					<h1>Terreno, Sector Luis Cordero</h1>
{/* 						<p class="price"><b>Precio: </b> $${producto.price}</p> */}
						<p class="description">
							<b>Descripcion: </b> <span>
                            El terreno está ubicado en el sector de Luis Cordero, se encuentra a 600 metros aproximadamente de la estación de metro Las Américas , en dirección norte, además de lo anterior, posee una vista provilegiada de la ciudad y está próximo a una institución de salud y a un centro educacional, y posee locomoción colectiva que llega directamente al sector.
              </span>
						</p>
            ...
            <div class="grid-item">Acometicas:</div>  
